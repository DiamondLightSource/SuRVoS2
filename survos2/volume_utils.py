...
def view(data, boundaries=None, overlay=None, bcolor="#000099", balpha=0.7, oalpha=0.5):
    ...
    if is_3d:
        ...
        plt.subplots_adjust(
            left=margin, bottom=margin, right=1 - margin, top=1 - margin
        )
        slider = Slider(
            axslider, "Slice:", 0, data.shape[0] - 1, valinit=idx, valfmt="%d"
        )
