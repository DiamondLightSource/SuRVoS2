...
#     filter = __objects_names__[order]
#     datasets = ws.existing_datasets(workspace, group=__objects_group__, filter=filter)
#     if full:
#         return {
...
@hug.local()
def existing(
    workspace: String, full: SmartBoolean = False, filter: SmartBoolean = True, order: Int = 0):
