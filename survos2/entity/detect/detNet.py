...
from survos2.entity.detect.fpn import (ConvGenerator, ResBlock, FPN, 
                                       Interpolate, MultiStepLR, NDConvGenerator, 
                                       SGD, StepLR, Configs, DefaultConfigs)
...
class detNet(nn.Module):
    ...
    def __init__(self, cf, logger):
        ...
        self.cf = cf
        self.logger = logger
        #backbone = import_module('bbone', cf.backbone_path)
    ...
    def forward(self, x):
        ...
        return out_features, seg_logits

    def train_fwd(self, img_batch):
        #img_batch, label_batch = batch
        #img = batch['data']
        #seg = batch['seg']
        
        var_img = img_batch
        #var_img = torch.FloatTensor(img_batch)# .cuda()
    ...
    def train_forwardDet(self, batch, **kwargs):
        """
    ...
    def test_forwardDet(self, batch, **kwargs):
        """
